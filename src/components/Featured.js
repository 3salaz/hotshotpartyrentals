    ...
    <section className="">
      <div className="container mx-auto p-2">
        <div className="-mx-4 p-16 flex flex-wrap justify-between items-center">
          ...
          <div className="w-full px-4 md:w-1/2 xl:w-1/3">
            <div className="overflow-hidden rounded-lg bg-white">
              <div className="w-full flex justify-center items-center">
                <img src={iphone} alt="image" className="text-center h-650" />
              </div>
              
              <div className="flex flex-row items-center justify-center gap-4">
                <div className="mx-3 py-4 flex justify-center items-center">
          ...
          <div className="w-full px-4 md:w-1/2 xl:w-1/3 drop-shadow-2xl">
            <div className="mb-10 overflow-hidden rounded-lg bg-white drop-shadow-2xl">
