...
function Greeting() {
  return (
    <section className="bg-gray-200 py-8">
      <div className="flex flex-col md:flex-row p-8 md:p-12 gap-8 items-center justify-center">
        <div className="basis-full md:basis-3/4 flex flex-col justify-center items-center gap-6 sm:py-8 px-4 rounded-lg drop-shadow-sm">
          <div className="text-sm text-center md:text-lg px-4">
            Thank you for visiting Hot Shot party rentals.<br></br>We value your
        ...
        <div className="basis-full md:basis-1/4 min-w-350 py-12 rounded-lg bg-white drop-shadow-lg md:h-full">
