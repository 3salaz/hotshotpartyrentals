            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
                ...
                >
                  ...
                  <div className="w-full">
                    <h4 className="text-lg font-semibold text-mainTeal">
                    How long will I have to wait to find out if my reservation was approved? 
                    </h4>
                  </div>
                </button>
                <div x-show="openFaq6" className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    Generally, we try to confirm all reservations within 48 hours. We have to check the date/time/location/product availability.                  </p>
                </div>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
                ...
                >
                  ...
                  <div className="w-full">
                    <h4 className="text-lg font-semibold text-mainTeal">
                    What type of event can I have?
                    </h4>
                  </div>
                </button>
                <div x-show="openFaq6" className="faq-content pl-[62px]">
                  <p className="py-3 text-base leading-relaxed text-body-color">
                    The sky is the limit. We can help celebrate a birthday party, graduation, fun summer activity, work event, school event, sports event, team building activity, reunion, and more! We offer something fun and exciting for all ages. Feel free to let us know how we can help with your next event.
                  </p>
                </div>
              </div>
