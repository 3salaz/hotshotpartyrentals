          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mt-10 lg:mt-0">
              ...
              <p className="text-body-color mb-8 text-base">
                ...
                and kind, but most of all an experienced business owner! This is
                my second business that I've started with the first one being
                extremely successful and rewarding (www.signgypsies.com) thanks
                to my many loyal customers.
              </p>
              <p className="text-body-color mb-12 text-base">
                I am very excited to be embarking on this new adventure. It is a
                vision I've had since my oldest daughter was three and I planned
                her nerf gun birthday party. I love the idea of offering a
                service that will handle all of your needs. We do everything
                from set up to breakdown, arrange the specifics for each unique
                Party Rental event and disinfectant all of our equipment after
                every event.
              </p>
              <p className="text-body-color mb-12 text-base">
                ...
                one and are helping them with the foam ball blasters of course.
                Hahaha).
              </p>
              <a
